...
const createWebToken = (body) => {
  const token = jwt.sign(body, SECRET_ACCESS_TOKEN, {
    expiresIn: "3h",
  });
...
const getTokenInfo = (req) => {
  ...
  return jwt.verify(accessToken, SECRET_ACCESS_TOKEN);
};

module.exports = { createWebToken, authenticateToken, getTokenInfo };
